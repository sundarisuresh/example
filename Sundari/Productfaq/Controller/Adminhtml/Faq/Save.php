...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create(\Sundari\Productfaq\Model\Faq::class)->load($id);
            if (!$model->getId() && $id) {
            ...
            try {
                ...
                $this->dataPersistor->clear('sundari_productfaq_faq');
            ...
            $this->dataPersistor->set('sundari_productfaq_faq', $data);
