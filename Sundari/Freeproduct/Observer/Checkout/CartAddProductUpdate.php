...
class CartAddProductUpdate implements \Magento\Framework\Event\ObserverInterface
{
...
//        $quote_item = $observer->getEvent()->getQuoteItem();
        ...
        $logger->info('text fdddd');
    return;
        $logger->info('text message' . print_r($quote_item->getData(), true));
